...
namespace TAS_Project.Database
{
    public class SeedEmployeeData : ISeedData
    {
        public void SeedData(){ //Method for Reseeding all the Employees
            ...
            cmd.CommandText=@"CREATE TABLE Employee(EmployeeId INTEGER PRIMARY KEY, FirstName TEXT, LastName TEXT, EmployeeEmail TEXT, EmployeeDepartment TEXT, EmploymentLevel TEXT, Admin BIT, Password TEXT, MgrId INTEGER, FOREIGN KEY(MgrId) REFERENCES Employee(EmployeeId))"; //Creates a new table
            cmd.ExecuteNonQuery();
