...
namespace TAS_Project.Database
{
    public class SeedQuestionData : ISeedData
    {
        public void SeedData(){ //Method for Reseeding all the Question Data
            ...
            cmd.CommandText=@"CREATE TABLE Question(QuestionId INTEGER PRIMARY KEY, QuestionText TEXT, QuestionRequired BIT, AnswerRequired BIT, AllowMultipleAnswers BIT, QuestionCategory TEXT, InputTypeId INTEGER, FOREIGN KEY(InputTypeId) REFERENCES InputType(InputTypeId))"; //Creates a new table
            cmd.ExecuteNonQuery();
